...
import theRetrospect.actions.timeline.RepositionTimelinesAction;
import theRetrospect.actions.timeline.TriggerAfterTimelineCollapseAction;
...
public class TimelineUtils {
    ...
    public static final String SHIFT_TIP = RetrospectMod.makeID("SHIFT_TIP");
