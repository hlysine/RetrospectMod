...
public class ShadowFormPower extends AbstractPower implements CloneablePowerInterface, TimelineConstructSubscriber {
    ...
    @Override
    public int modifyTimelineCount(AbstractCard constructionCard, int baseTimelineCount) {
        return baseTimelineCount + this.amount;
    }
