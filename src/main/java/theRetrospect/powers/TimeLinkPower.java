...
public class TimeLinkPower extends AbstractPower implements CloneablePowerInterface {

    public static final String POWER_ID = RetrospectMod.makeID(TimeLinkPower.class.getSimpleName());
    ...
    public TimeLinkPower(final AbstractCreature owner, int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new TimeLinkPower(owner, amount);
    }
}
