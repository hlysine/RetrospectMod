...
public class RetrospectMod implements
    ...
    public static Properties theRetrospectDefaultSettings = new Properties();
    ...
    public RetrospectMod() {
        ...
        theRetrospectDefaultSettings.setProperty(ENABLE_PLACEHOLDER_SETTINGS, "FALSE"); // This is the default setting. It's actually set...
        try {
            SpireConfig config = new SpireConfig("retrospectMod", "theRetrospectConfig", theRetrospectDefaultSettings); // ...right here
        ...
        ModLabeledToggleButton enableNormalsButton = new ModLabeledToggleButton("This is the text which goes next to the checkbox.",
                ...
                (button) -> { // The actual button:
                    ...
                    try {
                        ...
                        SpireConfig config = new SpireConfig("retrospectMod", "theRetrospectConfig", theRetrospectDefaultSettings);
