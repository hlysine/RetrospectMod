...
public class DefaultAttackWithVariable extends AbstractRetrospectCard {
    ...
    public static final String ID = RetrospectMod.makeID(DefaultAttackWithVariable.class.getSimpleName());
