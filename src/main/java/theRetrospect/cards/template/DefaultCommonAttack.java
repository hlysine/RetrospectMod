...
public class DefaultCommonAttack extends AbstractRetrospectCard {
    ...
    public static final String ID = RetrospectMod.makeID(DefaultCommonAttack.class.getSimpleName());
