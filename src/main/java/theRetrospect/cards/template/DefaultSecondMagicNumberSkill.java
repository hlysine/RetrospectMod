...
public class DefaultSecondMagicNumberSkill extends AbstractRetrospectCard {
    ...
    public static final String ID = RetrospectMod.makeID(DefaultSecondMagicNumberSkill.class.getSimpleName());
